...
export default function Home() {
  ...
  return (
    <main className={`min-h-screen transition-colors duration-300 ${
      isDarkMode ? "bg-[#0b1c2d] text-white" : "bg-slate-50 text-slate-900"
    }`}>
      <nav className={`flex justify-between items-center px-4 md:px-8 py-4 border-b sticky top-0 z-40 transition-colors ${
        isDarkMode ? "border-[#132f4c] bg-[#0b1c2d]/95 backdrop-blur-md" : "border-slate-200 bg-white/95 backdrop-blur-md"
      }`}>
        <div className="flex items-center gap-3">
          <div className="p-1 rounded-xl flex items-center justify-center">
            <img 
              src="/logo.png" 
              alt="GreenSpark Logo" 
              className="w-12 h-12 md:w-14 md:h-14 object-contain mix-blend-screen filter drop-shadow" 
            />
          </div>
          <div className="flex flex-col">
            <span className="text-lg md:text-2xl font-extrabold tracking-tight text-[#4CAF50] leading-none">GreenSpark</span>
        ...
        <div className="hidden md:flex items-center space-x-6 text-sm font-medium">
          <a href="#benefits" className="hover:text-[#4CAF50] transition">{t.navServices}</a>
          <a href="#booking" className="bg-[#4CAF50] hover:bg-[#43A047] text-white px-5 py-2.5 rounded-xl transition shadow-md shadow-[#4CAF50]/20 font-semibold">
            {t.navBook}
          </a>
          ...
          <button
            ...
            className={`p-2.5 rounded-xl border text-lg leading-none transition ${
              isDarkMode 
                ? "bg-[#132f4c] border-[#1d446d] text-yellow-400 hover:bg-[#193a5e]" 
          ...
          <select 
            ...
            className={`font-semibold px-3 py-2 rounded-xl focus:outline-none cursor-pointer border text-xs transition ${
              isDarkMode 
                ? "bg-[#132f4c] border-[#1d446d] text-[#4CAF50]" 
        ...
        <div className="flex md:hidden items-center space-x-2">
          <button
            ...
            className={`p-2 rounded-lg border text-sm transition ${
              isDarkMode ? "bg-[#132f4c] border-[#1d446d] text-yellow-400" : "bg-slate-100 border-slate-300 text-slate-700"
            }`}
          >
            {isDarkMode ? "☀️" : "🌙"}
          </button>
          ...
          <select 
            ...
            className={`font-semibold px-2 py-1.5 rounded-lg focus:outline-none border text-xs ${
              isDarkMode ? "bg-[#132f4c] border-[#1d446d] text-[#4CAF50]" : "bg-slate-100 border-slate-300 text-green-700"
            }`}
          >
          ...
          <button
            ...
            className={`p-2 rounded-lg border text-base ${
              isDarkMode ? "bg-[#132f4c] border-[#1d446d] text-white" : "bg-slate-100 border-slate-300 text-slate-900"
            }`}
          >
            {mobileMenuOpen ? "✕" : "☰"}
          </button>
      ...
      {mobileMenuOpen && (
        <div className={`md:hidden flex flex-col space-y-3 px-6 py-5 border-b shadow-lg transition-all ${
          isDarkMode ? "bg-[#132f4c] border-[#1d446d] text-white" : "bg-white border-slate-200 text-slate-900"
        }`}>
          <a 
            href="#benefits" 
            onClick={() => setMobileMenuOpen(false)}
            className="text-base font-medium py-1.5 hover:text-[#4CAF50]"
          >
            {t.navServices}
          </a>
          <a 
            href="#booking" 
            onClick={() => setMobileMenuOpen(false)}
            className="bg-[#4CAF50] text-center hover:bg-[#43A047] text-white px-4 py-2.5 rounded-xl font-medium transition shadow-md"
          >
            {t.navBook}
          </a>
        </div>
      ...
      <section className="flex flex-col items-center justify-center text-center px-4 pt-16 pb-8 max-w-5xl mx-auto">
        <h2 className="text-3xl sm:text-5xl md:text-6xl font-extrabold tracking-tight mb-6 leading-tight">
          {t.heroTitle1} <span className="text-[#4CAF50]">{t.heroTitle2}</span> {t.heroTitle3}
        </h2>
        ...
        <div id="benefits" className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mt-4 text-left">
          <div className={`p-6 rounded-2xl border transition hover:border-[#4CAF50] ${
            isDarkMode ? "bg-[#132f4c]/70 border-[#1d446d]" : "bg-white border-slate-200 shadow-sm"
          }`}>
            <h4 className="text-[#4CAF50] font-bold text-lg mb-2">{t.feat1Title}</h4>
          ...
          <div className={`p-6 rounded-2xl border transition hover:border-[#4CAF50] ${
            ...
            <h4 className="text-[#4CAF50] font-bold text-lg mb-2">{t.feat3Title}</h4>
      ...
      <section id="booking" className="max-w-2xl mx-auto px-4 pb-20 pt-10">
        <div className={`p-6 md:p-10 rounded-3xl shadow-2xl border transition ${
          ...
          <div className="flex bg-[#0b1c2d] p-1.5 rounded-xl border border-[#1d446d] mb-6">
            <button
              type="button"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <>
                <div>
                  ...
                  <input 
                    ...
                    className={`w-full rounded-xl px-4 py-3 border focus:outline-none focus:border-[#4CAF50] transition ${
                      isDarkMode ? "bg-[#0b1c2d] border-[#1d446d] text-white" : "bg-slate-50 border-slate-300 text-slate-900"
                    }`}
                  />
                </div>
                <div>
            ...
            <div className="pt-4">
              <label className={`block text-sm font-semibold mb-3 ${isDarkMode ? "text-[#4CAF50]" : "text-green-700"}`}>
                    ...
                    <div 
                      ...
                      className={`flex items-center justify-between p-3.5 rounded-xl border transition ${
                        isSelected 
                          ...
                          : isDarkMode ? "border-[#1d446d] bg-[#0b1c2d]/50" : "border-slate-200 bg-slate-50"
                      }`}
                    >
                      ...
                      {isSelected && (
                        <div className="flex items-center space-x-2">
                          ...
                          <input 
                            ...
                            className={`w-16 rounded-lg px-2.5 py-1.5 text-center text-sm border focus:outline-none focus:border-[#4CAF50] ${
                              isDarkMode ? "bg-[#0b1c2d] border-[#1d446d] text-white" : "bg-white border-slate-300 text-slate-900"
                            }`}
                          />
                        </div>
                      )}
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full bg-[#4CAF50] hover:bg-[#43A047] text-white font-semibold py-3.5 rounded-xl transition mt-6 shadow-lg shadow-[#4CAF50]/20 text-base disabled:opacity-50"
            >
      ...
      <footer className="bg-[#0b1c2d] text-slate-300 border-t border-[#132f4c] py-12 px-6 md:px-16">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs text-slate-400">
              <li><a href="#" className="hover:text-[#4CAF50] transition">Home</a></li>
              <li><a href="#" className="hover:text-[#4CAF50] transition">About Us</a></li>
              <li><a href="#" className="hover:text-[#4CAF50] transition">Values</a></li>
              <li><a href="#benefits" className="hover:text-[#4CAF50] transition">Services</a></li>
              <li><a href="#booking" className="hover:text-[#4CAF50] transition">Get Started</a></li>
              <li><a href="#" className="hover:text-[#4CAF50] transition">Legal Notice</a></li>
              <li><a href="#" className="hover:text-[#4CAF50] transition">Privacy Policy</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col space-y-2 text-xs text-slate-400">
              <a href="#" className="hover:text-[#4CAF50] transition flex items-center gap-2">📘 Facebook</a>
              <a href="#" className="hover:text-[#4CAF50] transition flex items-center gap-2">𝕏 X</a>
              <a href="#" className="hover:text-#[4CAF50] transition flex items-center gap-2">📷 Instagram</a>
            </div>
          </div>
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4">
          <div className={`max-w-md w-full p-6 rounded-3xl border shadow-2xl text-center transform transition-all ${
            ...
            <div className="w-16 h-16 bg-[#4CAF50]/20 border border-[#4CAF50] text-[#4CAF50] rounded-full flex items-center justify-center text-3xl mx-auto mb-4 shadow-inner">
              ✓
            </div>
            <h3 className="text-2xl font-bold mb-2 text-[#4CAF50]">{t.modalTitle}</h3>
            
            <div className={`my-4 p-4 rounded-2xl border text-center ${
              isDarkMode ? "bg-[#0b1c2d] border-[#4CAF50]/40" : "bg-green-50 border-green-300"
            }`}>
              <span className="text-xs text-slate-400 block mb-1">{t.modalIdLabel}</span>
              <span className="text-xl font-black text-[#4CAF50] tracking-wider font-mono">{generatedBookingId}</span>
            </div>
            ...
            <button
              ...
              className="w-full bg-[#4CAF50] hover:bg-[#43A047] text-white font-semibold py-3 rounded-xl transition shadow-lg shadow-[#4CAF50]/20 text-sm"
            >
              {t.modalBtn}
            </button>
          </div>
